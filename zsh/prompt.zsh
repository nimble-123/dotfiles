...
plugins=(git git-extras zsh-nvm rbenv gem ruby osx sudo colorize history history-substring-search last-working-dir compleat zsh-completions zsh-autosuggestions zsh-syntax-highlighting warhol)
